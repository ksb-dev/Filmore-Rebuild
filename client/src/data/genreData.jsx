...
export const genreArray = [
  ...
  },
  {
    ...
    icon1: <RxMagicWand size={'15px'} style={{ marginRight: '0.5rem' }} />,
    id: 14,
    genre: 'Fantasy',
    url: `https://api.themoviedb.org/3/discover/movie?&api_key=${
      import.meta.env.VITE_KEY
...

  {
    ...
    icon1: <BsHourglassSplit size={'15px'} style={{ marginRight: '0.5rem' }} />,
    id: 36,
    genre: 'History',
    url: `https://api.themoviedb.org/3/discover/movie?&api_key=${
      import.meta.env.VITE_KEY
  ...
  },
  {
    ...
    icon1: <SlGhost size={'15px'} style={{ marginRight: '0.5rem' }} />,
    id: 27,
    genre: 'Horror',
    url: `https://api.themoviedb.org/3/discover/movie?&api_key=${
      import.meta.env.VITE_KEY
  ...
  },
  {
    ...
    icon1: <SlMusicToneAlt size={'15px'} style={{ marginRight: '0.5rem' }} />,
    id: 10402,
    genre: 'Music',
    url: `https://api.themoviedb.org/3/discover/movie?&api_key=${
      import.meta.env.VITE_KEY
  ...
  },
  {
    ...
    icon1: <RiHeartsLine size={'15px'} style={{ marginRight: '0.5rem' }} />,
    id: 10749,
    genre: 'Romance',
    url: `https://api.themoviedb.org/3/discover/movie?&api_key=${
      import.meta.env.VITE_KEY
